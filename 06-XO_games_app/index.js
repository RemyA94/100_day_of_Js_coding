...
restartButton = '<button onclick="playAgain()"><img src="./restartBtn.svg" alt=""></button>';
...
function gameOver(a) {
    var gameOverAlertElement = "<b>GAME OVER </b><br> Player " + span[a].dataset.player.toUpperCase() + ' Win !!! <br><br>' + restartButton;
